...
def args_parser():
    ...
    parser.add_argument('--gen_data', type=int, default=0,
                        help='whether generate cifar10/100 trian/test data, not(0)/yes(1)')
    parser.add_argument('--diri_alpha', type=float, default=1.0,
                        help='dirichlet alpha for cifar10/100, sampling.py needs it')
    parser.add_argument('--imbalance_ratio', type=float, default=10.0,
                        help='imbalance ratio for cifar10/100, the largest class / the smallest class')
    parser.add_argument('--tt_ratio', type=float, default=0.1,
                        help='proportion of test set in training set for cifar10/100')
    parser.add_argument('--min_class', type=int, default=1, help='the number of minority classes for cifar10/100')
    parser.add_argument('--types', type=int, default=11, help='observation experiment type')

    # amp 
    parser.add_argument('--amp_alpha', type=float, default=0.05, help=' alpha for fedamp')
